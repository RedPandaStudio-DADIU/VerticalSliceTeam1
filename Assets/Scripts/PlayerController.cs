...
public class PlayerController : MonoBehaviour
{
    ...
    void ScarePlayer()
    {
        if (Input.GetKeyDown(KeyCode.E) && ((stateController.GetCurrentState() is FleeState) || (stateController.GetCurrentState() is IdleState && stateController.GetPreviousState() is FleeState)))
        {
